    ...
    return (
        <div className="w-full bg-E3F1F2 flex flex-col h-[100vh] items-center px-10 overflow-auto	">
            ...
            <div className="min-w-[300px] max-w-[560px] w-full flex flex-col my-20">
                <Image src="/images/pngs/checked.png" width={100} height={100} className="mx-auto" alt="Checked Icon" />
                <span className="text-32px font-bold text-slate-900 text-center mt-3">Verification Successfull</span>
