...
const History: React.FC<EducationStepProps> = ({ onScreen }) => {
  ...
  const fetchProfileData = async () => {
    ...
    try {
      ...
      setExperiences(response.data.result.data.workHistory.data || []);
    } catch (err) {
      toast.error(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (selectedExperience) {
      ...
      await updateProfileData(updatedResumeData);
    ...
    // Check subscription for adding new experience
